...
_url_format = 'https://s3.us-west-1.wasabisys.com/resnest/torch/{}-{}.pth_old'
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None,
        ...
        if radix >= 1:
            ...
            from SSL_Plaque.model.rfconv import RFConv2d
            self.conv2 = RFConv2d(
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, radix=1, groups=1, bottleneck_width=64,
                 num_classes=1000, dilated=False, dilation=1, feature_num=128,
        ...
        self.head = nn.Sequential(
            ...
            nn.ReLU(inplace=True),
            nn.Linear(512 * block.expansion, feature_num),
        )
